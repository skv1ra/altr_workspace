...
describe("auth validation", () => {
  ...
  it("enforces the 8-character password minimum on both login and register", () => {
    expect(loginSchema.safeParse({ email: "user@example.com", password: "short1" }).success).toBe(false);
    expect(
